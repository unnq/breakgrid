...
const TEAMS = [
  { id: "ari", name: "Arizona Cardinals", short: "ARI", logoUrl: "assets/logos/cardinals.webp" },
  { id: "atl", name: "Atlanta Falcons", short: "ATL", logoUrl: "assets/logos/falcons.webp" },
  { id: "bal", name: "Baltimore Ravens", short: "BAL", logoUrl: "assets/logos/ravens.webp" },
  { id: "buf", name: "Buffalo Bills", short: "BUF", logoUrl: "assets/logos/bills.webp" },
  { id: "car", name: "Carolina Panthers", short: "CAR", logoUrl: "assets/logos/panthers.webp" },
  { id: "chi", name: "Chicago Bears", short: "CHI", logoUrl: "assets/logos/bears.webp" },
  { id: "cin", name: "Cincinnati Bengals", short: "CIN", logoUrl: "assets/logos/bengals.webp" },
  { id: "cle", name: "Cleveland Browns", short: "CLE", logoUrl: "assets/logos/browns.webp" },
  { id: "dal", name: "Dallas Cowboys", short: "DAL", logoUrl: "assets/logos/cowboys.webp" },
  { id: "den", name: "Denver Broncos", short: "DEN", logoUrl: "assets/logos/broncos.webp" },
  { id: "det", name: "Detroit Lions", short: "DET", logoUrl: "assets/logos/lions.webp" },
  { id: "gb",  name: "Green Bay Packers", short: "GB",  logoUrl: "assets/logos/packers.webp" },
  { id: "hou", name: "Houston Texans", short: "HOU", logoUrl: "assets/logos/texans.webp" },
  { id: "ind", name: "Indianapolis Colts", short: "IND", logoUrl: "assets/logos/colts.webp" },
  { id: "jax", name: "Jacksonville Jaguars", short: "JAX", logoUrl: "assets/logos/jaguars.webp" },
  { id: "kc",  name: "Kansas City Chiefs", short: "KC",  logoUrl: "assets/logos/chiefs.webp" },
  { id: "lv",  name: "Las Vegas Raiders", short: "LV",  logoUrl: "assets/logos/raiders.webp" },
  { id: "lac", name: "Los Angeles Chargers", short: "LAC", logoUrl: "assets/logos/chargers.webp" },
  { id: "lar", name: "Los Angeles Rams", short: "LAR", logoUrl: "assets/logos/rams.webp" },
  { id: "mia", name: "Miami Dolphins", short: "MIA", logoUrl: "assets/logos/dolphins.webp" },
  { id: "min", name: "Minnesota Vikings", short: "MIN", logoUrl: "assets/logos/vikings.webp" },
  { id: "ne",  name: "New England Patriots", short: "NE",  logoUrl: "assets/logos/patriots.webp" },
  { id: "no",  name: "New Orleans Saints", short: "NO",  logoUrl: "assets/logos/saints.webp" },
  { id: "nyg", name: "New York Giants", short: "NYG", logoUrl: "assets/logos/giants.webp" },
  { id: "nyj", name: "New York Jets", short: "NYJ", logoUrl: "assets/logos/jets.webp" },
  { id: "phi", name: "Philadelphia Eagles", short: "PHI", logoUrl: "assets/logos/eagles.webp" },
  { id: "pit", name: "Pittsburgh Steelers", short: "PIT", logoUrl: "assets/logos/steelers.webp" },
  { id: "sf",  name: "San Francisco 49ers", short: "SF",  logoUrl: "assets/logos/49ers.webp" },
  { id: "sea", name: "Seattle Seahawks", short: "SEA", logoUrl: "assets/logos/seahawks.webp" },
  { id: "tb",  name: "Tampa Bay Buccaneers", short: "TB",  logoUrl: "assets/logos/buccaneers.webp" },
  { id: "ten", name: "Tennessee Titans", short: "TEN", logoUrl: "assets/logos/titans.webp" },
